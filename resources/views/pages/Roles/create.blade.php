                ...
                <div class="row align-items-center mb-4">
                    <div class="col">
                        <h2 class="h5 page-title mb-0">
                            <span class="fe fe-plus-circle fe-24 mr-2 text-primary"></span>إضافة دور جديد
                        </h2>
                        <p class="text-muted small mt-1 mb-0">أنشئ دوراً جديداً وحدد صلاحياته في النظام</p>
                    </div>
                    <div class="col-auto">
                ...
                <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                ...
                                <input type="text"
                                    ...
                                    name="name" value="{{ old('name') }}" placeholder="مثال: مدير، مشرف، موظف..."
                                    required>
                                @error('name')
                    ...
                    <div class="d-flex justify-content-end mb-4">
                        ...
                        <button type="submit" class="btn btn-primary shadow-sm px-4">
                            <span class="fe fe-save fe-16 mr-2"></span>حفظ الدور
                        </button>
                    </div>
                </form>
