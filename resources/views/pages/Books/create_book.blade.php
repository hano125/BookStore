                ...
                <div class="row align-items-center mb-4 page-header">
                    <div class="col">
                        <h2 class="page-title mb-0">
                            <span class="fe fe-file-plus fe-24 mr-2 text-primary"></span>إنشاء كتاب جديد
                        </h2>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card form-card mb-4 fade-in-up">
                    <div class="card-header">
                        <strong class="card-title mb-0">
                            <span class="fe fe-edit-3 fe-16 mr-2"></span>معلومات الكتاب
                        </strong>
                    </div>
                    <div class="card-body">
                        ...
                        {{-- Success Alert --}}
                        @if (session('success'))
                            <div class="alert alert-success alert-dismissible fade show alert-custom alert-success-custom mb-4"
                                role="alert">
                        ...
                        {{-- Error Alert --}}
                        @if ($errors->any())
                            <div class="alert alert-danger alert-dismissible fade show alert-custom alert-danger-custom mb-4"
                                role="alert">
                        ...
                        <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <select class="form-control @error('sender_entity') is-invalid @enderror"
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->deparment_name }}"
                                                {{ old('sender_entity') == $department->deparment_name ? 'selected' : '' }}>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('book_no') is-invalid @enderror"
                                        id="book_no" name="book_no" value="{{ old('book_no') }}"
                            ...
                            <div class="form-row">
                                    ...
                                    <select class="form-control @error('deparment_id') is-invalid @enderror"
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->id }}"
                                                {{ old('deparment_id') == $department->id ? 'selected' : '' }}>
                                                {{ $department->deparment_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="3"
                                        placeholder="أدخل ملاحظات إضافية (اختياري)">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-upload-wrapper">
                                    ...
                                    <div class="upload-hint">PDF, DOC, DOCX — الحد الأقصى 10 ميغابايت</div>
                            ...
                            <button type="button" class="btn btn-outline-primary btn-add-user mb-4" id="add-user">
                                <span class="fe fe-plus fe-16 mr-2"></span> الاشخاص الموجودين في الهامش
                            </button>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary">
                                    <span class="fe fe-save fe-16 mr-2"></span>حفظ الكتاب
                                </button>
